...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="http://localhost/no3/index.php"><h4>F E S T I C K E T</h4></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <!--li class="nav-item">
                    <a class="nav-link" href="http://localhost/no3/qna.php">Q n A</a>
                </li-->
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/no3/cart">장바구니</a>
                </li>
