    ...
    <div class="row">
        ...
        <div class="col-lg-9 mb-4">
            <div class="container">
                ...
                <div class="list-group">
                    <table class="table table-hover">
                        ...
                        while ($row = mysqli_fetch_array($result)) { // 실행할 때마다 한행씩 보여주고 값이 없으면 null 속성을 이용하여 반복문을 돌릴 수 있다
                            echo "<tbody>
                               <tr>
                                <td><img src='{$row['img']}' height='30px'></td>
                                <td>{$row['title']}</a></td>
                                <td>{$row['memo']}</td>
                                <td><a href=\"ad_edit.php?id={$row['id']}\">수정 </a>|<a href=\"process_ad_delete.php?id={$row['id']}\" 
                                onclick=\"return confirm('광고를 삭제합니다.');\"> 삭제</a></td>
                               </tr>
                               </tbody>";
                        }
                        ?>
                ...
                <div align="right">
                    <a class="pull-right row btn mb-4 list-grou list-group-item" style="width: 80px"
                       href="ad_create..php">추가</a>
                </div>
                <!-- Content Row
                <div class="row">
