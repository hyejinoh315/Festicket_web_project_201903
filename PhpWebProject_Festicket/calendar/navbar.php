        ...
        <ul class="navbar-nav ml-auto">
            ...
            <!--<li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                    <a class="dropdown-item" href="http://localhost/no3/sidebar.php">Festivals</a>
                    <a class="dropdown-item" href="http://localhost/no3/membership.php">회원관리</a>
                    <a class="dropdown-item" href="http://localhost/no3/qna.php">Q n A</a>
                    <a class="dropdown-item" href="http://localhost/no3/contact.php">Contact</a>
                </div>
            </li>-->
            <li class="nav-item">
