            ...
            <div class="list-group">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        $sql_query = "SELECT id, user_id, name, tel, birth, is_admin FROM users LIMIT 15";
                        $result = mysqli_query($conn, $sql_query) or die("database error:". mysqli_error($conn));
                        while( $developer = mysqli_fetch_assoc($result) ) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $developer['tel']; ?></td>
                                <td><?php echo $developer['birth']; ?></td>
                                <td><?php echo $developer['is_admin']; ?></td>
                                <td><a href=#>등급 수정 </a><!--|<a href=user_delete.php?id=<?=$developer['id']?>> 삭제</a>--></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
