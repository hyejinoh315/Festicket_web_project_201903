...
<form action="process_create.php" method="post">
    <p><input type="text" name="title" placeholder="페스티벌명" style="margin: auto; width: 100%;" required></p> <!--줄바꿈 태그-->
    <p>페스티벌 시작 날짜　<input type="date" name="date" required></p>
    <p>페스티벌 종료 날짜　<input type="date" name="date_end" required></p>
    <p><input type="text" name="locate" placeholder="운영장소" style="margin: auto; width: 100%;" required></p>
    <p><input type="number" name="price" placeholder="티켓금액" style="margin: auto; width: 100%;" required></p>
    <p><textarea name="memo" placeholder="본문" style="margin: auto; width: 100%; height: 300px;" required></textarea></p>
    <p><input type="file" name="img" placeholder="이미지경로" required></p>
